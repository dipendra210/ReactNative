...
class Store {
  ...
  // getSellingPosts() {
  //   axios
  //     .get("http://192.168.1.114:8000/posts/")
  //     .then(res => (this.sellingPosts = res.data));
  // }
  // GETS ALL THE BRANDS AVAILABLE IN THE DATABASE
  getBrands() {
    axios.get("http://192.168.1.114:8000/selling/brands/").then(res => {
  ...
  getBrandPost(id) {
    axios
      .get('http://192.168.1.114:8000/brand/posts/' + id)
  ...
  getPostDetail(id) {
    const thePostDetail = this.specificBrandPost.find(
      ...
      axios
        .post('http://192.168.1.114:8000/post/views/' + id)
  ...
  getLatestPosts() {
    axios
      .get("http://192.168.1.114:8000/latest/posts/")
  ...
  getMostViewed() {
    axios
      .get("http://192.168.1.114:8000/most/viewed/posts/")
